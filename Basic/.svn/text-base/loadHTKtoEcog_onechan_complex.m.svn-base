function [AAdata,phasedata]=loadHTKtoEcog_onechan_complex(mainpath,chanNum,timeInt)
...
AAdata=abs(complex(realdata,imagdata));
phasedata=angle(complex(realdata,imagdata));
