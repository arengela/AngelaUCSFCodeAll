function ecog=ecogRaw2EcogGUI(data,baselineDurMs,sampDur,badChannels,sampFreq, refChan,channel2GridMatrixIdx)
% ecog=ecogRaw2EcogGUI(data,baselineDurMs,sampDur,badChannels,refChan,channel2GridMatrixIdx) create an ecog structure with trials  
% PURPOSE:
