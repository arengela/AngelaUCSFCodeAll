function [filteredData,cfs,sigma_fs,hilbdata]=processingHilbertTransform_filterbankGUI_broad(ecog,Fs,freqRange)
%{
...
npbs=length(cfs);
sds=3*sigma_fs.*sqrt(2);%make filter 3 times as broad
