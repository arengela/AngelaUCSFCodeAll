...
high_frequency = [80 150; 200 300]; % define gamma band
sampling_rate = 1200; % define sampling rate
...
for x = 1:size(raw_data, 1)
    ...
    alphaTroughEvents(find(alphaTroughEvents<window_size(2)))=[]
    alphaTroughEvents(find(length(high_frequency_amplitude)-alphaTroughEvents<window_size(2)))=[]
    
    thetaTroughEvents(find(thetaTroughEvents<window_size(1)))=[]
    thetaTroughEvents(find(length(high_frequency_amplitude)-thetaTroughEvents<window_size(1)))=[]
    
        alphaPeakEvents(find(alphaPeakEvents<window_size(2)))=[]
    alphaPeakEvents(find(length(high_frequency_amplitude)-alphaPeakEvents<window_size(2)))=[]
    
    thetaPeakEvents(find(thetaPeakEvents<window_size(1)))=[]
    thetaPeakEvents(find(length(high_frequency_amplitude)-thetaPeakEvents<window_size(1)))=[]
...
thetaPower=zeros(256,2,161);
alphaPower=zeros(256,2,97);
