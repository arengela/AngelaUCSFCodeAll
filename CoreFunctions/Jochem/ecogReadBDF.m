function [data,numChan,labels,txt,fs,gain,prefiltering,ChanDim] =ecogReadBDF(filename,SecLoad,reshape)
%[data,numChan,labels,txt,fs,gain,prefiltering,ChanDim] = eeg_read_bdf(filename,SecLoad,reshape)
% Based on Code from:
