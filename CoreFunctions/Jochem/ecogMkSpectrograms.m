function ecog=ecogMkSpectrograms(ecog,trialList,param)
% ecog=ecogMkSpectrograms(ecog,trialList,param) calculates spectrograms of ecog data
%
...
if  ~exist('param') || isempty(param) || ~isfield(ecog.spectrogram,'params') %if nothing was passed or [] was passed or field does not exist
