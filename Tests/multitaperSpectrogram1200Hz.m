function [ecog]=multitaperSpectrogram1200Hz(ecog,trialList,params) %Calculate a periodogram for each data channel
...
if  ~exist('param','var') || isempty(param) || ~isfield(ecog.periodogram,'params') %if nothing was passed or [] was passed or field does not exist
    ...
    ecog.periodogram.params.fpass=[0 600]; % frequency of interest
